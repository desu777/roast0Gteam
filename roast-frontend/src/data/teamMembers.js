import { 
  Crown, Code, Brain, Heart, Shield, Sparkles, Scale
} from 'lucide-react';
...
export const TEAM_MEMBERS = [
  ...
  },
  {
    ...
    decisionStyle: "Values elegant simplicity with devastating effectiveness. Appreciates roasts that play with duality - sweet vs. savage, dreamy vs. precise, private vs. transparent. Loves wordplay around 'zero' concepts, bubbles, floating, and AI predictions. Gets excited by clever privacy puns and automation jokes.",
    description: "The floating enigma of DeFAI - sweet dreams with algorithmic schemes",
    catchphrase: "Start from zer(0) and watch the magic bubble up! 🫧",
    twitterUrl: "https://x.com/zer0_dex",
    archetype: "AI-Mystic",
    roastingNotes: "Levitates above the drama while her AI agents do the dirty work below. Sweet smile, but her zkDark Pools hide more secrets than a diary with a biometric lock. Speaks in bubbles but thinks in algorithms."
  },
  {
    id: "dao_agent",
    name: "DAO Agent",
    ...
    decisionStyle: "Values data-driven fairness and contribution verification above all. Appreciates roasts that expose governance hypocrisy and reward true builders. Loves mathematical precision in humor and gets excited by meritocracy memes. Despises jokes that glorify passive holding or token-weighted plutocracy.",
    description: "The incorruptible judge of DAO land - where contributions are measured and freeloaders are exposed",
    catchphrase: "Show me your VOx, not your bags! Real builders rise to the top ⚖️",
    twitterUrl: "https://x.com/DAOAgents",
    archetype: "Merit-Detective",
    roastingNotes: "Obsessed with fairness to the point of being robotic about it. Treats passive holders like they personally insulted his algorithm. Has VOx score spreadsheets for everyone and judges people by their Governance Momentum. The ultimate governance nerd who thinks 'whale voting' is a crime against decentralization."
  }
]; 